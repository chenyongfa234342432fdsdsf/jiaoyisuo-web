...
/**
 * 接口 [全仓强平订单详情↗](https://yapi.coin-online.cc/project/72/interface/api/1865) 的 **请求类型**
 *
 * @分类 [全仓杠杆模块接口↗](https://yapi.coin-online.cc/project/72/interface/api/cat_422)
 * @标签 `全仓杠杆模块接口`
 * @请求头 `GET /margin/cross/liquidationDetail`
 * @更新时间 `2022-08-29 13:58:21`
 */
export interface YapiGetMarginCrossLiquidationDetailApiRequest {
  /**
   * txId
   */
  txId?: string
...
/**
 * 接口 [全仓强平订单详情↗](https://yapi.coin-online.cc/project/72/interface/api/1865) 的 **返回类型**
 *
 * @分类 [全仓杠杆模块接口↗](https://yapi.coin-online.cc/project/72/interface/api/cat_422)
 * @标签 `全仓杠杆模块接口`
 * @请求头 `GET /margin/cross/liquidationDetail`
 * @更新时间 `2022-08-29 13:58:21`
 */
export interface YapiGetMarginCrossLiquidationDetailApiResponse {
  code?: number
