...
/**
 * 接口 [热币理财累计收益↗](https://yapi.coin-online.cc/project/72/interface/api/1622) 的 **请求类型**
 *
 * @分类 [热币宝理财↗](https://yapi.coin-online.cc/project/72/interface/api/cat_452)
 * @标签 `热币宝理财`
 * @请求头 `GET /finance/asset/profit/view`
 * @更新时间 `2022-08-29 13:58:11`
 */
export interface YapiGetFinanceAssetProfitViewApiRequest {
...
/**
 * 接口 [热币理财累计收益↗](https://yapi.coin-online.cc/project/72/interface/api/1622) 的 **返回类型**
 *
 * @分类 [热币宝理财↗](https://yapi.coin-online.cc/project/72/interface/api/cat_452)
 * @标签 `热币宝理财`
 * @请求头 `GET /finance/asset/profit/view`
 * @更新时间 `2022-08-29 13:58:11`
 */
export interface YapiGetFinanceAssetProfitViewApiResponse {
  code?: number
  data?: YapiDtoFinAssetTotalProfitDTO
  msg?: string
  pageNum?: number
  startDate?: string
  time?: number
...
export interface YapiDtoFinAssetTotalProfitDTO {
  fixedTotalProfit?: string
  fixedYesterdayProfit?: string
  flexibleTotalProfit?: string
  flexibleYesterdayProfit?: string
  startTime?: string
  totalProfit?: string
