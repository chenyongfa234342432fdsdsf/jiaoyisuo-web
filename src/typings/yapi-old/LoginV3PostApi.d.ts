...
/**
 * 接口 [登录，首先不传验证码，如果调用失败加验证码继续调用此接口↗](https://yapi.coin-online.cc/project/72/interface/api/2228) 的 **请求类型**
 *
 * @分类 [hotcoin优化相关接口↗](https://yapi.coin-online.cc/project/72/interface/api/cat_401)
 * @标签 `hotcoin优化相关接口`
 * @请求头 `POST /v3/login`
 * @更新时间 `2022-09-02 11:52:25`
 */
export interface YapiPostV3LoginApiRequest {
  /**
   * 加密后的业务数据
   */
  bizData?: string
...
/**
 * 接口 [登录，首先不传验证码，如果调用失败加验证码继续调用此接口↗](https://yapi.coin-online.cc/project/72/interface/api/2228) 的 **返回类型**
 *
 * @分类 [hotcoin优化相关接口↗](https://yapi.coin-online.cc/project/72/interface/api/cat_401)
 * @标签 `hotcoin优化相关接口`
 * @请求头 `POST /v3/login`
 * @更新时间 `2022-09-02 11:52:25`
 */
export interface YapiPostV3LoginApiResponse {
  code?: number
