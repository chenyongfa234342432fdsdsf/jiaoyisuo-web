...
/**
 * 接口 [获取涨幅或跌幅排行数据↗](https://yapi.coin-online.cc/project/72/interface/api/2282) 的 **请求类型**
 *
 * @分类 [trade-ws-api-controller↗](https://yapi.coin-online.cc/project/72/interface/api/cat_413)
 * @标签 `trade-ws-api-controller`
 * @请求头 `POST /v3/tradeInfoRankingList`
 * @更新时间 `2022-08-29 13:58:36`
 */
export interface YapiPostV3TradeInfoRankingListApiRequest {
  /**
   * pageSize
   */
  pageSize?: string
...
/**
 * 接口 [获取涨幅或跌幅排行数据↗](https://yapi.coin-online.cc/project/72/interface/api/2282) 的 **返回类型**
 *
 * @分类 [trade-ws-api-controller↗](https://yapi.coin-online.cc/project/72/interface/api/cat_413)
 * @标签 `trade-ws-api-controller`
 * @请求头 `POST /v3/tradeInfoRankingList`
 * @更新时间 `2022-08-29 13:58:36`
 */
export interface YapiPostV3TradeInfoRankingListApiResponse {
  code?: number
