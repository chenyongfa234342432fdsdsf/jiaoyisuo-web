...
async function callOnBeforeRouteHook(onBeforeRouteHook, pageContext) {
    ...
    if ((0, utils_1.hasProp)(hookReturn.pageContext, 'url')) {
        (0, utils_1.assertWarning)(false, `${errPrefix} returned \`{ pageContext: { url } }\` but \`pageContext.url\` has been renamed to \`pageContext.urlOriginal\`. Return \`{ pageContext: { urlOriginal } }\` instead. (See https://vite-plugin-ssr.com/migration/0.4.23 for more information.)`, { onlyOnce: true });
