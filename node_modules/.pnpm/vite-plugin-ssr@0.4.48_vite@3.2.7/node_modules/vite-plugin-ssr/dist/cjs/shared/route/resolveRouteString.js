...
function resolveRouteString(routeString, urlPathname) {
    (0, utils_2.assertUsage)(routeString === '*' || routeString.startsWith('/'), `Invalid route string \`${routeString}\`${routeString === '' ? ' (empty string)' : ''}: route strings should start with a leading slash \`/\` (or be \`*\`).`);
