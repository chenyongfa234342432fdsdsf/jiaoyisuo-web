...
async function route(pageContext) {
    ...
    const { pageRoutes, onBeforeRouteHook } = await (0, loadPageRoutes_2.loadPageRoutes)(pageContext);
    ...
    (0, utils_1.assertUsage)(pageContext._pageFilesAll.length > 0, 'No *.page.js file found. You must create at least one *.page.js file.');
