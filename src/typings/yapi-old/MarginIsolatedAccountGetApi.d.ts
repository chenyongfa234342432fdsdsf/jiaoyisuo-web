...
/**
 * 接口 [逐仓杠杆总资产、负债、账户权益↗](https://yapi.coin-online.cc/project/72/interface/api/1892) 的 **请求类型**
 *
 * @分类 [逐仓杠杆交易↗](https://yapi.coin-online.cc/project/72/interface/api/cat_461)
 * @标签 `逐仓杠杆交易`
 * @请求头 `GET /margin/isolated/account`
 * @更新时间 `2022-08-29 13:58:22`
 */
export interface YapiGetMarginIsolatedAccountApiRequest {}

/**
 * 接口 [逐仓杠杆总资产、负债、账户权益↗](https://yapi.coin-online.cc/project/72/interface/api/1892) 的 **返回类型**
 *
 * @分类 [逐仓杠杆交易↗](https://yapi.coin-online.cc/project/72/interface/api/cat_461)
 * @标签 `逐仓杠杆交易`
 * @请求头 `GET /margin/isolated/account`
 * @更新时间 `2022-08-29 13:58:22`
 */
export interface YapiGetMarginIsolatedAccountApiResponse {
  code?: number
  data?: YapiDtoMagIsolatedAssetsVO
  msg?: string
  pageNum?: number
  startDate?: string
  time?: number
 ...
 * 逐仓杠杆资产
 */
export interface YapiDtoMagIsolatedAssetsVO {
  /**
   * 总资产折合成人民币
   */
