...
/**
 * 接口 [查询理财产品详情↗](https://yapi.coin-online.cc/project/72/interface/api/1676) 的 **请求类型**
 *
 * @分类 [热币宝理财↗](https://yapi.coin-online.cc/project/72/interface/api/cat_452)
 * @标签 `热币宝理财`
 * @请求头 `GET /finance/product/detail`
 * @更新时间 `2022-08-29 13:58:14`
 */
export interface YapiGetFinanceProductDetailApiRequest {
...
/**
 * 接口 [查询理财产品详情↗](https://yapi.coin-online.cc/project/72/interface/api/1676) 的 **返回类型**
 *
 * @分类 [热币宝理财↗](https://yapi.coin-online.cc/project/72/interface/api/cat_452)
 * @标签 `热币宝理财`
 * @请求头 `GET /finance/product/detail`
 * @更新时间 `2022-08-29 13:58:14`
 */
export interface YapiGetFinanceProductDetailApiResponse {
  code?: number
  data?: YapiDtoFinanceProduct
  msg?: string
  pageNum?: number
  startDate?: string
  time?: number
...
export interface YapiDtoFinanceProduct {
  coinId?: number
  issueAmount?: string
  lockPeriod?: number
  productId?: number
