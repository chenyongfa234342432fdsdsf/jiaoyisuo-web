...
/**
 * 接口 [企业认证-查询认证账户交易员草稿↗](https://yapi.coin-online.cc/project/72/interface/api/1754) 的 **请求类型**
 *
 * @分类 [实人认证↗](https://yapi.coin-online.cc/project/72/interface/api/cat_434)
 * @标签 `实人认证`
 * @请求头 `GET /identity/company/traderInfo`
 * @更新时间 `2022-08-29 13:58:17`
 */
export interface YapiGetIdentityCompanyTraderInfoApiRequest {
  /**
...
/**
 * 接口 [企业认证-查询认证账户交易员草稿↗](https://yapi.coin-online.cc/project/72/interface/api/1754) 的 **返回类型**
 *
 * @分类 [实人认证↗](https://yapi.coin-online.cc/project/72/interface/api/cat_434)
 * @标签 `实人认证`
 * @请求头 `GET /identity/company/traderInfo`
 * @更新时间 `2022-08-29 13:58:17`
 */
export interface YapiGetIdentityCompanyTraderInfoApiResponse {
  code?: number
