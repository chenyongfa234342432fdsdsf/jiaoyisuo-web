...
export declare type PageContextBuiltInClient<Page = any> = Partial<PageContextBuiltIn<Page>> & Pick<PageContextBuiltIn<Page>, 'Page' | 'pageExports' | 'exports' | 'url' | 'urlOriginal' | 'urlPathname' | 'urlParsed'> & {
