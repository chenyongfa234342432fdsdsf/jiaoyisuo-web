...
cli
    ...
    (0, utils_1.assertWarning)(false, 'The `$ vite-plugin-ssr prerender` CLI is outdated. Set the `vite.config.js` option `prerender` instead. See https://vite-plugin-ssr.com/prerender-config for more information.', { onlyOnce: true });
    assertOptions();
