...
/**
 * 接口 [getSystemCoinTypeList↗](https://yapi.coin-online.cc/project/72/interface/api/1508) 的 **请求类型**
 *
 * @分类 [充提币相关接口↗](https://yapi.coin-online.cc/project/72/interface/api/cat_419)
 * @标签 `充提币相关接口`
 * @请求头 `POST /capital/getSystemCoinTypeList`
 * @更新时间 `2022-08-29 13:58:07`
 */
export interface YapiPostCapitalGetSystemCoinTypeListApiRequest {}

/**
 * 接口 [getSystemCoinTypeList↗](https://yapi.coin-online.cc/project/72/interface/api/1508) 的 **返回类型**
 *
 * @分类 [充提币相关接口↗](https://yapi.coin-online.cc/project/72/interface/api/cat_419)
 * @标签 `充提币相关接口`
 * @请求头 `POST /capital/getSystemCoinTypeList`
 * @更新时间 `2022-08-29 13:58:07`
 */
export interface YapiPostCapitalGetSystemCoinTypeListApiResponse {
  code?: number
