...
/**
 * 接口 [指纹、手势登录接口↗](https://yapi.coin-online.cc/project/72/interface/api/2231) 的 **请求类型**
 *
 * @分类 [hotcoin优化相关接口↗](https://yapi.coin-online.cc/project/72/interface/api/cat_401)
 * @标签 `hotcoin优化相关接口`
 * @请求头 `POST /v3/login/gestureFingerprints`
 * @更新时间 `2022-09-02 11:53:33`
 */
export interface YapiPostV3LoginGestureFingerprintsApiRequest {
  /**
   * 加密后的业务数据
   */
  bizData?: string
...
/**
 * 接口 [指纹、手势登录接口↗](https://yapi.coin-online.cc/project/72/interface/api/2231) 的 **返回类型**
 *
 * @分类 [hotcoin优化相关接口↗](https://yapi.coin-online.cc/project/72/interface/api/cat_401)
 * @标签 `hotcoin优化相关接口`
 * @请求头 `POST /v3/login/gestureFingerprints`
 * @更新时间 `2022-09-02 11:53:33`
 */
export interface YapiPostV3LoginGestureFingerprintsApiResponse {
  code?: number
