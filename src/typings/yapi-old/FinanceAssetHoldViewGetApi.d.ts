...
/**
 * 接口 [热币理财持仓列表↗](https://yapi.coin-online.cc/project/72/interface/api/1619) 的 **请求类型**
 *
 * @分类 [热币宝理财↗](https://yapi.coin-online.cc/project/72/interface/api/cat_452)
 * @标签 `热币宝理财`
 * @请求头 `GET /finance/asset/hold/view`
 * @更新时间 `2022-08-29 13:58:11`
 */
export interface YapiGetFinanceAssetHoldViewApiRequest {
...
/**
 * 接口 [热币理财持仓列表↗](https://yapi.coin-online.cc/project/72/interface/api/1619) 的 **返回类型**
 *
 * @分类 [热币宝理财↗](https://yapi.coin-online.cc/project/72/interface/api/cat_452)
 * @标签 `热币宝理财`
 * @请求头 `GET /finance/asset/hold/view`
 * @更新时间 `2022-08-29 13:58:11`
 */
export interface YapiGetFinanceAssetHoldViewApiResponse {
  code?: number
  data?: YapiDtoFinAssetHoldDTO[]
  msg?: string
  pageNum?: number
  startDate?: string
  time?: number
...
export interface YapiDtoFinAssetHoldDTO {
  coinId?: number
