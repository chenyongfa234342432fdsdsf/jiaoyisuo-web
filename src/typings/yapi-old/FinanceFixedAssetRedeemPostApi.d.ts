...
/**
 * 接口 [定期持仓资产强制赎回接口↗](https://yapi.coin-online.cc/project/72/interface/api/1634) 的 **请求类型**
 *
 * @分类 [热币宝理财↗](https://yapi.coin-online.cc/project/72/interface/api/cat_452)
 * @标签 `热币宝理财`
 * @请求头 `POST /finance/fixed/asset/redeem`
 * @更新时间 `2022-08-29 13:58:12`
 */
export interface YapiPostFinanceFixedAssetRedeemApiRequest {
  autoTransfer?: number
  /**
   * 币种id
   */
...
/**
 * 接口 [定期持仓资产强制赎回接口↗](https://yapi.coin-online.cc/project/72/interface/api/1634) 的 **返回类型**
 *
 * @分类 [热币宝理财↗](https://yapi.coin-online.cc/project/72/interface/api/cat_452)
 * @标签 `热币宝理财`
 * @请求头 `POST /finance/fixed/asset/redeem`
 * @更新时间 `2022-08-29 13:58:12`
 */
export interface YapiPostFinanceFixedAssetRedeemApiResponse {
  code?: number
