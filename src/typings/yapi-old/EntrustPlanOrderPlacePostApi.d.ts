...
/**
 * 接口 [计划委托下单↗](https://yapi.coin-online.cc/project/72/interface/api/1613) 的 **请求类型**
 *
 * @分类 [币币优化↗](https://yapi.coin-online.cc/project/72/interface/api/cat_440)
 * @标签 `币币优化`
 * @请求头 `POST /entrust/plan/order/place`
 * @更新时间 `2022-09-02 11:23:29`
 */
export interface YapiPostEntrustPlanOrderPlaceApiRequest {
  /**
   * 加密后的业务数据
   */
  bizData?: string
...
/**
 * 接口 [计划委托下单↗](https://yapi.coin-online.cc/project/72/interface/api/1613) 的 **返回类型**
 *
 * @分类 [币币优化↗](https://yapi.coin-online.cc/project/72/interface/api/cat_440)
 * @标签 `币币优化`
 * @请求头 `POST /entrust/plan/order/place`
 * @更新时间 `2022-09-02 11:23:29`
 */
export interface YapiPostEntrustPlanOrderPlaceApiResponse {
  code?: number
  msg?: string
  pageNum?: number
  startDate?: string
