...
/**
 * 接口 [理财活期产品详情↗](https://yapi.coin-online.cc/project/72/interface/api/1688) 的 **请求类型**
 *
 * @分类 [热币宝理财↗](https://yapi.coin-online.cc/project/72/interface/api/cat_452)
 * @标签 `热币宝理财`
 * @请求头 `GET /finance/product/flexible/detail`
 * @更新时间 `2022-08-29 13:58:14`
 */
export interface YapiGetFinanceProductFlexibleDetailApiRequest {
...
/**
 * 接口 [理财活期产品详情↗](https://yapi.coin-online.cc/project/72/interface/api/1688) 的 **返回类型**
 *
 * @分类 [热币宝理财↗](https://yapi.coin-online.cc/project/72/interface/api/cat_452)
 * @标签 `热币宝理财`
 * @请求头 `GET /finance/product/flexible/detail`
 * @更新时间 `2022-08-29 13:58:14`
 */
export interface YapiGetFinanceProductFlexibleDetailApiResponse {
  code?: number
  data?: YapiDtoFinFlexibleProductDTO
  msg?: string
  pageNum?: number
  startDate?: string
  time?: number
