...
/**
 * 接口 [热币理财记录列表↗](https://yapi.coin-online.cc/project/72/interface/api/1628) 的 **请求类型**
 *
 * @分类 [热币宝理财↗](https://yapi.coin-online.cc/project/72/interface/api/cat_452)
 * @标签 `热币宝理财`
 * @请求头 `GET /finance/asset/record/list`
 * @更新时间 `2022-08-29 13:58:12`
 */
export interface YapiGetFinanceAssetRecordListApiRequest {
...
/**
 * 接口 [热币理财记录列表↗](https://yapi.coin-online.cc/project/72/interface/api/1628) 的 **返回类型**
 *
 * @分类 [热币宝理财↗](https://yapi.coin-online.cc/project/72/interface/api/cat_452)
 * @标签 `热币宝理财`
 * @请求头 `GET /finance/asset/record/list`
 * @更新时间 `2022-08-29 13:58:12`
 */
export interface YapiGetFinanceAssetRecordListApiResponse {
  code?: number
