...
/**
 * 接口 [理财活期产品持仓资产↗](https://yapi.coin-online.cc/project/72/interface/api/1655) 的 **请求类型**
 *
 * @分类 [热币宝理财↗](https://yapi.coin-online.cc/project/72/interface/api/cat_452)
 * @标签 `热币宝理财`
 * @请求头 `GET /finance/flexible/hold/asset`
 * @更新时间 `2022-08-29 13:58:13`
 */
export interface YapiGetFinanceFlexibleHoldAssetApiRequest {
...
/**
 * 接口 [理财活期产品持仓资产↗](https://yapi.coin-online.cc/project/72/interface/api/1655) 的 **返回类型**
 *
 * @分类 [热币宝理财↗](https://yapi.coin-online.cc/project/72/interface/api/cat_452)
 * @标签 `热币宝理财`
 * @请求头 `GET /finance/flexible/hold/asset`
 * @更新时间 `2022-08-29 13:58:13`
 */
export interface YapiGetFinanceFlexibleHoldAssetApiResponse {
  code?: number
  data?: YapiDtoFinFlexibleHoldAssetDTO
  msg?: string
  pageNum?: number
  startDate?: string
  time?: number
...
export interface YapiDtoFinFlexibleHoldAssetDTO {
  autoTransfer?: number
  coinId?: number
  day7ProfitRate?: YapiDtoFinanceDay7ProfitRate[]
  inProfitAmount?: string
  inRedeemAmount?: string
  productId?: number
