...
/**
 * 接口 [查询币对信息↗](https://yapi.coin-online.cc/project/72/interface/api/2042) 的 **请求类型**
 *
 ...
 */
export interface YapiGetSymbolListApiRequest {
  /**
...
/**
 * 接口 [查询币对信息↗](https://yapi.coin-online.cc/project/72/interface/api/2042) 的 **返回类型**
 *
 * @分类 [币币优化↗](https://yapi.coin-online.cc/project/72/interface/api/cat_440)
 * @标签 `币币优化`
 * @请求头 `GET /symbol/list`
 * @更新时间 `2022-08-29 13:58:27`
 */
export interface YapiGetSymbolListApiResponse {
  code?: number
  data?: YapiDtoSymbolVO[]
  msg?: string
  pageNum?: number
  startDate?: string
  time?: number
