...
/**
 * 接口 [理财定期产品持仓详情↗](https://yapi.coin-online.cc/project/72/interface/api/1640) 的 **请求类型**
 *
 * @分类 [热币宝理财↗](https://yapi.coin-online.cc/project/72/interface/api/cat_452)
 * @标签 `热币宝理财`
 * @请求头 `GET /finance/fixed/hold/detail`
 * @更新时间 `2022-08-29 13:58:12`
 */
export interface YapiGetFinanceFixedHoldDetailApiRequest {
...
/**
 * 接口 [理财定期产品持仓详情↗](https://yapi.coin-online.cc/project/72/interface/api/1640) 的 **返回类型**
 *
 * @分类 [热币宝理财↗](https://yapi.coin-online.cc/project/72/interface/api/cat_452)
 * @标签 `热币宝理财`
 * @请求头 `GET /finance/fixed/hold/detail`
 * @更新时间 `2022-08-29 13:58:12`
 */
export interface YapiGetFinanceFixedHoldDetailApiResponse {
  code?: number
  data?: YapiDtoFinFixedHoldDetailDTO
  msg?: string
  pageNum?: number
  startDate?: string
  time?: number
...
export interface YapiDtoFinFixedHoldDetailDTO {
  coinId?: number
  estimateProfit?: string
  orderList?: YapiDtoFinanceOrder[]
  productType?: number
  productTypeDesc?: string
  totalAmount?: string
}
export interface YapiDtoFinanceOrder {
  coinId?: number
  createdTime?: string
  effectTime?: string
  expireTime?: string
