...
/**
 * 接口 [查询用户资产↗](https://yapi.coin-online.cc/project/72/interface/api/2156) 的 **请求类型**
 *
 ...
 */
export interface YapiPostV2BalanceApiRequest {}

/**
 * 接口 [查询用户资产↗](https://yapi.coin-online.cc/project/72/interface/api/2156) 的 **返回类型**
 *
 * @分类 [user-api-v-2-controller↗](https://yapi.coin-online.cc/project/72/interface/api/cat_416)
 * @标签 `user-api-v-2-controller`
 * @请求头 `POST /v2/balance`
 * @更新时间 `2022-08-29 13:58:31`
 */
export interface YapiPostV2BalanceApiResponse {
  code?: number
  data?: YapiDtoAssetVO
  msg?: string
  pageNum?: number
