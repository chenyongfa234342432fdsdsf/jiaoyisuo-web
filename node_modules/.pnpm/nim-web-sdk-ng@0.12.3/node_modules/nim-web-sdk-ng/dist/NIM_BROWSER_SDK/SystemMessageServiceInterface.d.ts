...
export declare const ESystemMessageType: {
    /**
     * @Multi_Lang_Tag
     * @locale cn
     * team 相关
...
export declare type TSysMsgPushInfo = {
    /**
     * @Multi_Lang_Tag
     * @locale cn
     * 是否需要推送
     ...
     *
     * @locale en
     * Whether to forcibly push notifications (which can be extended to a push form that is different from ordinary push); the default value is 0 when sending custom system notifications.
     * @locale
     */
     ...
     * 强推的成员账号
     *
     * 例：JSON.stringify(['id1', 'id2'])
     * 注：如果要设置为强推所有成员，则将此参数设置为 "#%@all@%#"
     * @locale
     *
     * @locale en
     * Accounts that need to receive system notifications that are forcibly pushed to them.
     *
     * Example: JSON.stringify (['id1', 'id2'])
     * Note: If you want to forcibly push system notifications to all members, set this parameter to "#%@all@%#"
     * @locale
     */
     ...
     *
     * @locale en
     * Texts that are forcibly pushed (can be extended to be different from normal push texts); the length is limited to 150 bytes.
     * @locale
     */
    pushContent?: string;
};
export declare type TSystemMessageAntiSpamInfo = {
    /**
     * @Multi_Lang_Tag
     * @locale cn
...
export declare type TSysMsgRecallMsgInfo = {
    /**
     * @Multi_Lang_Tag
     * @locale cn
     * 消息撤回需要透传给回客户端用的字段
...
export declare type TSysMsgSetting = {
    /**
     * @Multi_Lang_Tag
     * @locale cn
     * 自定义消息是否存入离线
...
export declare type SendCustomSysMsgOptions = {
    /**
     * @Multi_Lang_Tag
     * @locale cn
     * 通知的目标, 账号或者群ID
