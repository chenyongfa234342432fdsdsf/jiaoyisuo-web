...
import TradePairList from '../../../features/assets/margin/margin-fee/tradepair-list/index';
...
export type ICommonTradePairType = Partial<YapiGetV1TradePairListData> | YapiGetV1PerpetualTradePairListData
