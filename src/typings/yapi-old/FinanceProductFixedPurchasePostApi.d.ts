...
/**
 * 接口 [定期理财产品申购接口↗](https://yapi.coin-online.cc/project/72/interface/api/1685) 的 **请求类型**
 *
 * @分类 [热币宝理财↗](https://yapi.coin-online.cc/project/72/interface/api/cat_452)
 * @标签 `热币宝理财`
 * @请求头 `POST /finance/product/fixed/purchase`
 * @更新时间 `2022-08-29 13:58:14`
 */
export interface YapiPostFinanceProductFixedPurchaseApiRequest {
  autoFlexible?: number
  autoTransfer?: number
  /**
   * 币种id
...
/**
 * 接口 [定期理财产品申购接口↗](https://yapi.coin-online.cc/project/72/interface/api/1685) 的 **返回类型**
 *
 * @分类 [热币宝理财↗](https://yapi.coin-online.cc/project/72/interface/api/cat_452)
 * @标签 `热币宝理财`
 * @请求头 `POST /finance/product/fixed/purchase`
 * @更新时间 `2022-08-29 13:58:14`
 */
export interface YapiPostFinanceProductFixedPurchaseApiResponse {
  code?: number
  data?: number
  msg?: string
  pageNum?: number
