...
/**
 * 接口 [理财活期产品收益记录↗](https://yapi.coin-online.cc/project/72/interface/api/1661) 的 **请求类型**
 *
 * @分类 [热币宝理财↗](https://yapi.coin-online.cc/project/72/interface/api/cat_452)
 * @标签 `热币宝理财`
 * @请求头 `GET /finance/flexible/profit/list`
 * @更新时间 `2022-08-29 13:58:13`
 */
export interface YapiGetFinanceFlexibleProfitListApiRequest {
...
/**
 * 接口 [理财活期产品收益记录↗](https://yapi.coin-online.cc/project/72/interface/api/1661) 的 **返回类型**
 *
 * @分类 [热币宝理财↗](https://yapi.coin-online.cc/project/72/interface/api/cat_452)
 * @标签 `热币宝理财`
 * @请求头 `GET /finance/flexible/profit/list`
 * @更新时间 `2022-08-29 13:58:13`
 */
export interface YapiGetFinanceFlexibleProfitListApiResponse {
  code?: number
  data?: YapiDtoFinFlexibleProfitDTO[]
  msg?: string
  pageNum?: number
  startDate?: string
  time?: number
...
export interface YapiDtoFinFlexibleProfitDTO {
  createdTime?: string
