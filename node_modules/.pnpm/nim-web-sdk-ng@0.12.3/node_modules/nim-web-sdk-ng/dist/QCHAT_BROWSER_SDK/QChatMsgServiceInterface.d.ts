...
export interface QChatMsgServiceInterface {
     ...
     * 批量查询消息是否 @ 当前用户
     *
     * 注: 1. 自己发出的消息为 false, 2. 艾特所有人, 被艾特的账号包含本账号, 被艾特的身份组的账号中的包含自己的 为 true.
     *
...
export declare type NIMEQChatAreMentionedMeMessagesResult = {
    /**
     * key 为消息的客户端 id, value 用于判定消息是否 @ 当前用户.
     */
    [key: string]: boolean;
};
export declare type NIMEQChatAreMentionedMeMessagesOptions = {
    /**
     * 待查询的消息列表
     */
    messages: QChatMessage[];
};
export declare type NIMEQChatGetMentionedMeMessagesOptions = {
    /**
     * 服务器 id
     */
    serverId: string;
...
export declare type NIMEQChatGetMentionedMeMessagesResults = {
    /**
     * 分页信息
     */
    pageInfo: {
...
export declare type QChatSearchMsgByPageResult = {
    /**
     * 分页便捷选项
     */
    listQueryTag: {
...
export declare type QChatSearchMsgByPageOptions = {
    /**
     * 检索关键字
     */
    keyword?: string;
...
export declare type QChatMessageForGEOAttach = {
    /**
     * GEO 地理位置信息专属：纬度
     */
    lat?: number;
...
export declare type QChatMessage = {
    /**
     * 消息所属的服务器的id
     */
    serverId: string;
 ...
 * 消息引用结构，用于存在回复消息的情况
 */
export declare type QChatMessageRefer = {
    /**
     * 消息发送者的账号
     */
    fromAccount: string;
 ...
 */
export declare type NIMEQChatSystemNotificationAttachMyMemberInfoUpdated = {
...
export declare type QChatSystemNotification = {
    /**
     * 通知所属的服务器的id
     */
    serverId: string;
...
export declare type QChatMessageAntiSpamInfo = {
    /**
...
export declare type SendSystemNotificationOptions = {
    /**
     * 通知所属的服务器的id
     */
    serverId: string;
...
export declare type GetHistoryMessageOptions = {
    /**
     * 所属的服务器的id
     */
    serverId: string;
...
export declare type MarkSystemNotificationsReadOptions = {
...
export declare type RovokeMessageOptions = {
    /**
     * 操作附言
     */
    ps?: string;
...
export declare type MarkMesaageReadOptions = {
    /**
     * 服务器id
     */
    serverId: string;
...
export declare type UpdateSystemNotificationOptions = {
    /**
     * 操作附言
     */
    ps?: string;
...
export declare type GetMessageHistoryByIdsOptions = {
    /**
     * 服务器id
     */
    serverId: string;
...
export declare type GetReferMessagesOptions = {
    /**
     * 某消息
     */
...
export declare type GetReferMessagesResult = {
    /**
     * 被回复的消息
     */
    replyMessage?: QChatMessage;
...
export declare type GetThreadMessagesOptions = {
    /**
     * 要查询的消息
     *
     * 注：可以是根消息，也可以是子消息
...
export declare type GetThreadMessagesResult = {
    /**
     * thread 根消息的消息引用结构
     */
...
export declare type QChatUpdateQuickCommentOptions = {
    /**
     * 被评论消息
     */
...
export declare type QChatGetQuickCommentsOptions = {
    /**
     * 消息所属的服务器的id
     */
    serverId: string;
 ...
 * 快捷评论的内容
 */
export declare type QChatQuickCommentDetail = {
    /**
     * 评论类型
     */
    type: number;
...
export declare type QChatGetQuickCommentsResult = {
    /**
     * key 为 msgIdServer
     */
    [key: string]: {
...
export declare type QChatQuickCommentRequest = {
    /**
     * 消息所属的服务器的id
     */
    serverId: string;
...
export declare type GetThreadRootMessagesMetaOptions = {
    /**
     * 服务器的id
     */
    serverId: string;
...
export declare type QChatSendTypingEventOptions = {
    /**
     * 服务器id
     */
    serverId: string;
...
export declare type QChatGetLastMessageOfChannelsOptions = {
    /**
     * 服务器 ID
     */
    serverId: string;
...
export declare type QChatGetLastMessageOfChannelsResult = {
    /**
     * 其中 key 为 channelId
     */
 ...
 * 消息更新的操作信息
 */
export declare type QChatMessageUpdateOperatorInfo = {
    /**
     * 操作者账号 id
     */
