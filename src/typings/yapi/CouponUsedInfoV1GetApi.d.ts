...
export interface YapiGetV1CouponUsedInfoListData {
  ...
  orderId: string
  /**
   * 活动或者任务名称；如果是mission，任务名称 根据任务类型取字典 welfare_common_condition_scene_options 和welfare_achievments_mission_condition_options;如果是activity则直接展示
   */
  activityName?: string
  /**
