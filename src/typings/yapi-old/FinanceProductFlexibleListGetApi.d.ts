...
/**
 * 接口 [理财活期产品列表↗](https://yapi.coin-online.cc/project/72/interface/api/1691) 的 **请求类型**
 *
 * @分类 [热币宝理财↗](https://yapi.coin-online.cc/project/72/interface/api/cat_452)
 * @标签 `热币宝理财`
 * @请求头 `GET /finance/product/flexible/list`
 * @更新时间 `2022-08-29 13:58:14`
 */
export interface YapiGetFinanceProductFlexibleListApiRequest {
...
/**
 * 接口 [理财活期产品列表↗](https://yapi.coin-online.cc/project/72/interface/api/1691) 的 **返回类型**
 *
 * @分类 [热币宝理财↗](https://yapi.coin-online.cc/project/72/interface/api/cat_452)
 * @标签 `热币宝理财`
 * @请求头 `GET /finance/product/flexible/list`
 * @更新时间 `2022-08-29 13:58:14`
 */
export interface YapiGetFinanceProductFlexibleListApiResponse {
  code?: number
