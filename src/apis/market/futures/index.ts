...
/** 引用报错 注释了 */
// import {
//   YapiGetPerpetualMarketRestV1CandlesListApiRequest,
//   YapiGetPerpetualMarketRestV1CandlesListApiResponse,
// } from '@/typings/yapi/PerpetualMarketRestCandlesListV1GetApi'
import {
...
/**
 * [合约指数-k 线图↗](https://yapi.nbttfc365.com/project/44/interface/api/650)
 * */
/** 返回泛型报错 注释了 */
export const getPerpetualMarketRestV1CandlesListApiRequest: MarkcoinRequest = params => {
  return request({
    path: '/perpetual-market-rest/v1/candles/list',
    method: 'GET',
    params,
  })
}
