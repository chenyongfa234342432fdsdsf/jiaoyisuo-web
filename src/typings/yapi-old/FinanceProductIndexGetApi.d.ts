...
/**
 * 接口 [热币理财产品索引↗](https://yapi.coin-online.cc/project/72/interface/api/1697) 的 **请求类型**
 *
 * @分类 [热币宝理财↗](https://yapi.coin-online.cc/project/72/interface/api/cat_452)
 * @标签 `热币宝理财`
 * @请求头 `GET /finance/product/index`
 * @更新时间 `2022-08-29 13:58:15`
 */
export interface YapiGetFinanceProductIndexApiRequest {
...
/**
 * 接口 [热币理财产品索引↗](https://yapi.coin-online.cc/project/72/interface/api/1697) 的 **返回类型**
 *
 * @分类 [热币宝理财↗](https://yapi.coin-online.cc/project/72/interface/api/cat_452)
 * @标签 `热币宝理财`
 * @请求头 `GET /finance/product/index`
 * @更新时间 `2022-08-29 13:58:15`
 */
export interface YapiGetFinanceProductIndexApiResponse {
  code?: number
  data?: YapiDtoFinProductIndexDTO
  msg?: string
  pageNum?: number
  startDate?: string
  time?: number
...
export interface YapiDtoFinProductIndexDTO {
  fixedList?: YapiDtoFinFixedProductDTO[]
  flexibleList?: YapiDtoFinFlexibleProductDTO[]
}
...
export interface YapiDtoFinFlexibleProductDTO {
  availableAsset?: string
  coinId?: number
  day7ProfitRate?: YapiDtoFinanceDay7ProfitRate[]
  dayProfitEvery1000?: string
  effectTime?: string
  fullDayProfit?: string
  issueAmount?: string
  lockPeriod?: number
  productId?: number
  productName?: string
...
export interface YapiDtoFinanceDay7ProfitRate {
  dayIndex?: string
  profitRate?: string
}
