...
const getPageFilesClientSide_1 = require("./analyzePageClientSide/getPageFilesClientSide");
const getPageFilesServerSide_1 = require("./analyzePageServerSide/getPageFilesServerSide");
...
function analyzePageClientSide(pageFilesAll, pageId) {
    let pageFilesClientSide = (0, getPageFilesClientSide_1.getPageFilesClientSide)(pageFilesAll, pageId);
    ...
    if (isHtmlOnly) {
        ...
        pageFilesClientSide = pageFilesClientSide.filter((p) => p.fileType === '.page.client' && !(0, getExportNames_1.getExportNames)(p).includes('render'));
...
async function analyzePageClientSideInit(pageFilesAll, pageId, { sharedPageFilesAlreadyLoaded }) {
    const pageFilesClientSide = (0, getPageFilesClientSide_1.getPageFilesClientSide)(pageFilesAll, pageId);
    await Promise.all(pageFilesClientSide.map(async (p) => {
        (0, utils_1.assert)(p.fileType === '.page' || p.fileType === '.page.client');
