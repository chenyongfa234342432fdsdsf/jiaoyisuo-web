...
exports.pipeNodeStream = exports.pipeWebStream = exports.pipeStream = exports.stampPipe = exports.isStreamWritableNode = exports.isStreamWritableWeb = exports.streamPipeNodeToString = exports.streamReadableWebToString = exports.inferStreamName = exports.getStreamName = exports.streamToString = exports.isStream = exports.processStream = exports.pipeToStreamWritableWeb = exports.pipeToStreamWritableNode = exports.getStreamReadableWeb = exports.getStreamReadableNode = void 0;
...
async function processStream(streamOriginal, { injectStringAtBegin, injectStringAtEnd, onErrorWhileStreaming, enableEagerStreaming }) {
    ...
    function flushBuffer() {
        if (isInitializing() || !isReadyToWrite)
            return;
    ...
    function flushStream() {
        if (isInitializing() || !isReadyToWrite)
            return;
        if (!shouldFlushStream || streamOperations.flushStream === null)
            return;
...
async function manipulateStream({ streamOriginal, onError, onData, onEnd, onFlush, onReadyToWrite }) {
    ...
    if (isStreamPipeNode(streamOriginal)) {
        ...
        return { streamWrapper: pipeProxy, streamOperations: { writeChunk, flushStream } };
    }
    ...
    if (isStreamReadableWeb(streamOriginal)) {
        ...
        const flushStream = null;
        return { streamWrapper: readableProxy, streamOperations: { writeChunk, flushStream } };
    }
