...
/**
 * 接口 [活期持仓资产赎回参数↗](https://yapi.coin-online.cc/project/72/interface/api/1664) 的 **请求类型**
 *
 * @分类 [热币宝理财↗](https://yapi.coin-online.cc/project/72/interface/api/cat_452)
 * @标签 `热币宝理财`
 * @请求头 `GET /finance/flexible/redeem/intro`
 * @更新时间 `2022-08-29 13:58:13`
 */
export interface YapiGetFinanceFlexibleRedeemIntroApiRequest {
...
/**
 * 接口 [活期持仓资产赎回参数↗](https://yapi.coin-online.cc/project/72/interface/api/1664) 的 **返回类型**
 *
 * @分类 [热币宝理财↗](https://yapi.coin-online.cc/project/72/interface/api/cat_452)
 * @标签 `热币宝理财`
 * @请求头 `GET /finance/flexible/redeem/intro`
 * @更新时间 `2022-08-29 13:58:13`
 */
export interface YapiGetFinanceFlexibleRedeemIntroApiResponse {
  code?: number
  data?: YapiDtoFinFlexibleRedeemIntroDTO
  msg?: string
  pageNum?: number
  startDate?: string
  time?: number
...
export interface YapiDtoFinFlexibleRedeemIntroDTO {
  availableAsset?: string
  coinId?: number
  dailyRedeemAvailable?: string
