  ...
  return [
    {
      ...
      async resolveId(id) {
        if (id === "/virtual:vavite-connect-handler") {
          ...
          return import_path.default.resolve(dirname, clientAssetsDir ? bundleSirv ? "entry-standalone-bundled-sirv.mjs" : "entry-standalone-imported-sirv.mjs" : "entry-standalone.mjs");
        }
      }
    },
    {
