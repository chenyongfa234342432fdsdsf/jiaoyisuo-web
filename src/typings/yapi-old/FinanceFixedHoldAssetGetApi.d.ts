...
/**
 * 接口 [理财定期产品持仓资产↗](https://yapi.coin-online.cc/project/72/interface/api/1637) 的 **请求类型**
 *
 * @分类 [热币宝理财↗](https://yapi.coin-online.cc/project/72/interface/api/cat_452)
 * @标签 `热币宝理财`
 * @请求头 `GET /finance/fixed/hold/asset`
 * @更新时间 `2022-08-29 13:58:12`
 */
export interface YapiGetFinanceFixedHoldAssetApiRequest {
...
/**
 * 接口 [理财定期产品持仓资产↗](https://yapi.coin-online.cc/project/72/interface/api/1637) 的 **返回类型**
 *
 * @分类 [热币宝理财↗](https://yapi.coin-online.cc/project/72/interface/api/cat_452)
 * @标签 `热币宝理财`
 * @请求头 `GET /finance/fixed/hold/asset`
 * @更新时间 `2022-08-29 13:58:12`
 */
export interface YapiGetFinanceFixedHoldAssetApiResponse {
  code?: number
  data?: YapiDtoFinFixedHoldAssetDTO
  msg?: string
  pageNum?: number
  startDate?: string
  time?: number
...
export interface YapiDtoFinFixedHoldAssetDTO {
  coinId?: number
  createdTime?: string
  effectTime?: string
  expireTime?: string
