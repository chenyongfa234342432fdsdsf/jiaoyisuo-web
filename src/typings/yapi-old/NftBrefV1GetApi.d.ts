...
/**
 * 接口 [getNftBref↗](https://yapi.coin-online.cc/project/72/interface/api/2135) 的 **请求类型**
 *
 ...
 */
export interface YapiGetV1NftBrefApiRequest {
  /**
   * lang
   */
  lang?: string
...
/**
 * 接口 [getNftBref↗](https://yapi.coin-online.cc/project/72/interface/api/2135) 的 **返回类型**
 *
 * @分类 [nft-controller↗](https://yapi.coin-online.cc/project/72/interface/api/cat_407)
 * @标签 `nft-controller`
 * @请求头 `GET /v1/nft/bref`
 * @更新时间 `2022-08-29 13:58:31`
 */
export interface YapiGetV1NftBrefApiResponse {
  code?: number
  data?: YapiDtoNftTag[]
  msg?: string
  pageNum?: number
