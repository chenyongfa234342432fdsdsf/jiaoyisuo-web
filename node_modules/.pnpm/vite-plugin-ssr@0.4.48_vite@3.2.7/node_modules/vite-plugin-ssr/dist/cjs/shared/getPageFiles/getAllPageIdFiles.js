...
exports.getAllPageIdFilesServerSide = exports.getAllPageIdFilesClientSide = void 0;
const utils_1 = require("../utils");
function getAllPageIdFilesClientSide(pageFilesAll, pageId) {
    return determine(pageFilesAll, pageId, true);
}
exports.getAllPageIdFilesClientSide = getAllPageIdFilesClientSide;
function getAllPageIdFilesServerSide(pageFilesAll, pageId) {
    return determine(pageFilesAll, pageId, false);
}
exports.getAllPageIdFilesServerSide = getAllPageIdFilesServerSide;
function determine(pageFilesAll, pageId, forClientSide) {
    ...
    let pageFiles = [pageIdFileEnv, pageIdFileIso, ...defaultFilesNonRenderer, rendererFileEnv, rendererFileIso].filter(utils_1.isNotNullish);
    return pageFiles;
}
