...
/**
 * 接口 [理财定期产品列表↗](https://yapi.coin-online.cc/project/72/interface/api/1682) 的 **请求类型**
 *
 * @分类 [热币宝理财↗](https://yapi.coin-online.cc/project/72/interface/api/cat_452)
 * @标签 `热币宝理财`
 * @请求头 `GET /finance/product/fixed/list`
 * @更新时间 `2022-08-29 13:58:14`
 */
export interface YapiGetFinanceProductFixedListApiRequest {
...
/**
 * 接口 [理财定期产品列表↗](https://yapi.coin-online.cc/project/72/interface/api/1682) 的 **返回类型**
 *
 * @分类 [热币宝理财↗](https://yapi.coin-online.cc/project/72/interface/api/cat_452)
 * @标签 `热币宝理财`
 * @请求头 `GET /finance/product/fixed/list`
 * @更新时间 `2022-08-29 13:58:14`
 */
export interface YapiGetFinanceProductFixedListApiResponse {
  code?: number
