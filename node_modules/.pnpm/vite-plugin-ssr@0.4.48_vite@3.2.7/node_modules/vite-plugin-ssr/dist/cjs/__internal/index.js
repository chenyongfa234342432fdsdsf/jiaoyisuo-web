...
const globalContext_1 = require("../node/globalContext");
...
async function getPagesAndRoutes() {
    ...
    await (0, globalContext_1.getGlobalContext)(true);
    const { pageFilesAll, allPageIds } = await (0, getPageFiles_1.getPageFilesAll)(false, true);
    const { pageRoutes } = await (0, route_1.loadPageRoutes)({
