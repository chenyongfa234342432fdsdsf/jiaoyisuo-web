...
/**
 * 接口 [理财产品用户剩余可购(手)↗](https://yapi.coin-online.cc/project/72/interface/api/1700) 的 **请求类型**
 *
 * @分类 [热币宝理财↗](https://yapi.coin-online.cc/project/72/interface/api/cat_452)
 * @标签 `热币宝理财`
 * @请求头 `GET /finance/product/userLeftQuota`
 * @更新时间 `2022-08-29 13:58:15`
 */
export interface YapiGetFinanceProductUserLeftQuotaApiRequest {
...
/**
 * 接口 [理财产品用户剩余可购(手)↗](https://yapi.coin-online.cc/project/72/interface/api/1700) 的 **返回类型**
 *
 * @分类 [热币宝理财↗](https://yapi.coin-online.cc/project/72/interface/api/cat_452)
 * @标签 `热币宝理财`
 * @请求头 `GET /finance/product/userLeftQuota`
 * @更新时间 `2022-08-29 13:58:15`
 */
export interface YapiGetFinanceProductUserLeftQuotaApiResponse {
  code?: number
  data?: YapiDtoFinUserLeftQuota
  msg?: string
  pageNum?: number
  startDate?: string
  time?: number
...
export interface YapiDtoFinUserLeftQuota {
  availableAsset?: string
  availableAssetHand?: number
  remainAmount?: string
  remainAmountHand?: number
}
