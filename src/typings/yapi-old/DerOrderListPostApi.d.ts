...
/**
 * 接口 [质押借币用户订单列表↗](https://yapi.coin-online.cc/project/72/interface/api/1577) 的 **请求类型**
 *
 ...
 * @请求头 `POST /der/order/list`
 * @更新时间 `2022-08-29 13:58:10`
 */
export interface YapiPostDerOrderListApiRequest {
  /**
   * 借币时间-end
   */
  endTime?: number
...
/**
 * 接口 [质押借币用户订单列表↗](https://yapi.coin-online.cc/project/72/interface/api/1577) 的 **返回类型**
 *
 * @分类 [hotcoin-der-service-controller↗](https://yapi.coin-online.cc/project/72/interface/api/cat_398)
 * @标签 `hotcoin-der-service-controller`
 * @请求头 `POST /der/order/list`
 * @更新时间 `2022-08-29 13:58:10`
 */
export interface YapiPostDerOrderListApiResponse {
  code?: number
