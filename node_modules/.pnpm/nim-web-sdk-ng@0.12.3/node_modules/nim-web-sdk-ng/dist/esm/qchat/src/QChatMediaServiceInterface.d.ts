...
export declare type QChatMediaMember = {
    accid: string;
    isAudioOn: boolean;
    isVideoOn: boolean;
...
export declare type QChatMemberVolumeInfo = {
    userUuid: string;
    volume: number;
};
export declare type QChatMediaVideoView = HTMLElement | string;
export declare type UpdateRTCChannelInfoOptions = {
    /**
     * 服务器ID
     */
    serverId: string;
...
export declare type updateRTCChannelInfoResult = {
    /**
     * 房间配置下的roleConfigs的人数限制
     */
    limit: number;
...
export declare type GetRTCChannelInfoOptions = {
    /**
     * 服务器ID
     */
    serverId: string;
...
export declare type GetRTCChannelInfoResult = {
    /**
     * 房间配置下的roleConfigs的人数限制
     */
    limit: number;
...
export declare type GetRTCChannelOnlineMembersOptions = {
    /**
     * 服务器ID
     */
    serverId: string;
...
export declare type KickMemberOutOptions = {
    /**
     * 移除成员的用户id
     */
    accid: string;
};
export declare type MuteAudioOptions = {
    /**
     * 关闭成员音频的用户id
     */
    accid: string;
};
export declare type UnMuteAudioOptions = {
    /**
     * 打开成员音频的用户id
     */
    accid: string;
};
export declare type MuteVideoOptions = {
    /**
     * 关闭成员视频的accid
     */
    accid: string;
};
export declare type UnMuteVideoOptions = {
    /**
     * 打开成员视频的accid
     */
    accid: string;
};
export declare type StopMemberScreenShareOptions = {
    /**
     * 成员accid
     */
    accid: string;
};
export declare type SubscribeRemoteVideoStreamOptions = {
    /**
     * 成员accid
     */
    accid: string;
...
export declare type UnSubscribeRemoteVideoStreamOptions = {
    /**
     * 成员accid
     */
    accid: string;
...
export declare type SubscribeRemoteVideoSubStreamOptions = {
    /**
     * 成员accid
     */
    accid: string;
};
export declare type UnSubScribeRemoteVideoSubStreamOptions = {
    /**
     * 成员accid
     */
    accid: string;
};
export declare type SetupVideoCanvasOptions = {
    /**
     * dom元素或‘#id’，‘.class’
     */
...
export declare type SetupRemoteVideoSubStreamCanvasOptions = {
    /**
     * dom元素或‘#id’，‘.class’
     */
    videoView: QChatMediaVideoView;
...
export declare type SetSelectedRecordDeviceOptions = {
    /**
     * 设备Id
     */
    deviceId: string;
};
export declare type SetSelectedCameraDeviceOptions = {
    /**
     * 设备Id
     */
    deviceId: string;
};
export declare type SetSelectedPlayoutDeviceOptions = {
    /**
     * 设备Id
     */
    deviceId: string;
...
export declare type QChatMediaMemberInfo = {
    /**
     * 服务器ID
     */
    serverId: string;
