...
/**
 * 接口 [查询订单委托详情↗](https://yapi.coin-online.cc/project/72/interface/api/1604) 的 **请求类型**
 *
 * @分类 [币币优化↗](https://yapi.coin-online.cc/project/72/interface/api/cat_440)
 * @标签 `币币优化`
 * @请求头 `GET /entrust/detail`
 * @更新时间 `2022-08-29 13:58:11`
 */
export interface YapiGetEntrustDetailApiRequest {
  /**
   * 委单ID
   */
  entrustId?: string
  /**
   * 委托类型（0-限价委托、1-市价委托、4-计划委托），新版本必传
   */
  matchType?: string
}

/**
 * 接口 [查询订单委托详情↗](https://yapi.coin-online.cc/project/72/interface/api/1604) 的 **返回类型**
 *
 * @分类 [币币优化↗](https://yapi.coin-online.cc/project/72/interface/api/cat_440)
 * @标签 `币币优化`
 * @请求头 `GET /entrust/detail`
 * @更新时间 `2022-08-29 13:58:11`
 */
export interface YapiGetEntrustDetailApiResponse {
  code?: number
