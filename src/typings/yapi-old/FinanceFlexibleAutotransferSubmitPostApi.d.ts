...
/**
 * 接口 [活期持仓资产自动转入确认↗](https://yapi.coin-online.cc/project/72/interface/api/1652) 的 **请求类型**
 *
 * @分类 [热币宝理财↗](https://yapi.coin-online.cc/project/72/interface/api/cat_452)
 * @标签 `热币宝理财`
 * @请求头 `POST /finance/flexible/autoTransfer/submit`
 * @更新时间 `2022-08-29 13:58:13`
 */
export interface YapiPostFinanceFlexibleAutoTransferSubmitApiRequest {
  autoTransfer?: number
  /**
   * 币种id
   */
...
/**
 * 接口 [活期持仓资产自动转入确认↗](https://yapi.coin-online.cc/project/72/interface/api/1652) 的 **返回类型**
 *
 * @分类 [热币宝理财↗](https://yapi.coin-online.cc/project/72/interface/api/cat_452)
 * @标签 `热币宝理财`
 * @请求头 `POST /finance/flexible/autoTransfer/submit`
 * @更新时间 `2022-08-29 13:58:13`
 */
export interface YapiPostFinanceFlexibleAutoTransferSubmitApiResponse {
  code?: number
  data?: number
  msg?: string
  pageNum?: number
