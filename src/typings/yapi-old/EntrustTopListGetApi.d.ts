...
/**
 * 接口 [交易页分页查询委托↗](https://yapi.coin-online.cc/project/72/interface/api/1616) 的 **请求类型**
 *
 * @分类 [币币优化↗](https://yapi.coin-online.cc/project/72/interface/api/cat_440)
 * @标签 `币币优化`
 * @请求头 `GET /entrust/top/list`
 * @更新时间 `2022-08-29 13:58:11`
 */
export interface YapiGetEntrustTopListApiRequest {
  /**
   * 页码
   */
  pageNum?: string
...
/**
 * 接口 [交易页分页查询委托↗](https://yapi.coin-online.cc/project/72/interface/api/1616) 的 **返回类型**
 *
 * @分类 [币币优化↗](https://yapi.coin-online.cc/project/72/interface/api/cat_440)
 * @标签 `币币优化`
 * @请求头 `GET /entrust/top/list`
 * @更新时间 `2022-08-29 13:58:11`
 */
export interface YapiGetEntrustTopListApiResponse {
  code?: number
