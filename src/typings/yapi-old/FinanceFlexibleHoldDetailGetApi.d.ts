...
/**
 * 接口 [理财活期产品持仓详情↗](https://yapi.coin-online.cc/project/72/interface/api/1658) 的 **请求类型**
 *
 * @分类 [热币宝理财↗](https://yapi.coin-online.cc/project/72/interface/api/cat_452)
 * @标签 `热币宝理财`
 * @请求头 `GET /finance/flexible/hold/detail`
 * @更新时间 `2022-08-29 13:58:13`
 */
export interface YapiGetFinanceFlexibleHoldDetailApiRequest {
...
/**
 * 接口 [理财活期产品持仓详情↗](https://yapi.coin-online.cc/project/72/interface/api/1658) 的 **返回类型**
 *
 * @分类 [热币宝理财↗](https://yapi.coin-online.cc/project/72/interface/api/cat_452)
 * @标签 `热币宝理财`
 * @请求头 `GET /finance/flexible/hold/detail`
 * @更新时间 `2022-08-29 13:58:13`
 */
export interface YapiGetFinanceFlexibleHoldDetailApiResponse {
  code?: number
  data?: YapiDtoFinFlexibleHoldDetailDTO
  msg?: string
  pageNum?: number
  startDate?: string
  time?: number
...
export interface YapiDtoFinFlexibleHoldDetailDTO {
  autoTransfer?: number
  coinId?: number
