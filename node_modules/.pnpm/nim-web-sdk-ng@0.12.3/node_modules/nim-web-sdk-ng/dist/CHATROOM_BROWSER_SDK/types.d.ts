...
export declare type ChatroomMember = {
    /**
     * account id
     */
    account: string;
     ...
     *
     * @locale en
     * Whether the member is a visitor
     * @locale
     */
    guest?: boolean;
    /**
     ...
     *
     * @locale en
     * Whether online or not; only fixed members can be offline; visitors can only be online.
     * @locale
     */
    online: boolean;
    /**
     ...
     *
     * @locale en
     * The time when the member entered the chatroom; if offline, there is no such field.
     * @locale
     */
    enterTime?: number;
    /**
     ...
     *
     * @locale en
     * Remaining time of temporary mute
     * @locale
     */
...
export declare type ChatroomMessage = {
    /**
     * @Multi_Lang_Tag
     * @locale cn
     * 聊天室的 id
     ...
     *
     * @locale en
     * Extension field for the sender
     * @locale
     */
    fromExt?: string;
    /**
     ...
     *
     * @locale en
     * The flow (received or sent out) of messages
     * 'in' means this message received
     * 'out' means this message is sent out.
     * @locale
     */
    flow: 'in' | 'out';
    /**
     ...
     *
     * @locale en
     * Whether to cancel saving historical messages to the cloud:
     * False: do not cancel, True: cancel.
     ...
     *
     * @locale en
     * Message types such as additional content, custom, file, geo (location) will come with this:
     * @locale
     */
    attach?: StrAnyObj;
    /**
     ...
     *
     * @locale en
     * Extension field for server third-party callbacks
     * @locale
     */
    callbackExt?: string;
    /**
     ...
     *
     * @locale en
     * Developer-defined message subtype. Format requirement: an integer greater than 0.
     * @locale
     */
    subType?: string;
    /**
     ...
     *
     * @locale en
     * Environment variables used in configurations such as data synchronization and third-party callbacks.
     * @locale
     */
    env?: string;
    /**
     ...
     *
     * @locale en
     * If GuardEase anti-spam is enabled, spam detection will be returned via this parameter.
     * @locale
     */
...
export interface IBaseUploadFileOptions {
     ...
     *
     * @locale en
     * The DOM element that stores the file. You only need to fill in the DOM element or the above-mentioned File.
     *
     * Browser specific
     *
     * If you input a string, you will get the File object via document.getElementById (' fileInput ').files[0].
     * If input a DOM node, get the File object via fileInput.files [0].
     * @locale
     */
     ...
     *
     * @locale en
     * Storage valid time. Default value: the instantiation configuration.
     *
...
export interface IBaseSendMsgOptions {
     ...
     *
     * @locale en
     * GuardEase anti-cheat field.  The value should be a JSON string not longer than 1’024 bytes. Example: "{"email":"test@163.com","phone":"12345678901","token":"1234","extension":"hello"}"
     * @locale
     */
     ...
     *
     * @locale en
     * GuardEase Anti-Cheat Extension Field, added on 2021-08-09. The value should be a JSON string not longer than 1024 bytes.
     * @locale
     */
...
export interface IBaseMarkChatroomMemberOptions {
     ...
     *
     * When someone is added as an administrator, all chatroom members will receive a notification message of the ' addManager ' type.
     * When an administrator is removed, all chatroom members will receive a notification message of the ' removeManager ' type.
     *
     * When someone is added as a common member, all chatroom members will receive a notification message of the ' addCommon ' type.
     * When a common member is removed, all chatroom members will receive a notification message of the ' removeCommon ' type.
     *
     * When someone is added to the mute list, all chatroom members will receive a notification message of the ' gagMember ' type.
     * When someone is removed from the mute list, all chatroom members will receive a notification message of the ' ungagMember ' type.
     *
     * When someone is blacklisted, all chatroom members will receive a notification message of the ' blackMember ' type.
     * When someone is removed from the blacklist, all chatroom members will receive a notification message of the ' unblackMember ' type.
     * @locale
     */
    isAdd: boolean;
    /**
     ...
     *
     * It is recommended that you use JSON format strings to construct the extension field.
     * @locale
     */
    ext: string;
}
