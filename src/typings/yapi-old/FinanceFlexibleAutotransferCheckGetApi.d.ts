...
/**
 * 接口 [活期持仓资产自动转入确认前校验↗](https://yapi.coin-online.cc/project/72/interface/api/1646) 的 **请求类型**
 *
 * @分类 [热币宝理财↗](https://yapi.coin-online.cc/project/72/interface/api/cat_452)
 * @标签 `热币宝理财`
 * @请求头 `GET /finance/flexible/autoTransfer/check`
 * @更新时间 `2022-08-29 13:58:12`
 */
export interface YapiGetFinanceFlexibleAutoTransferCheckApiRequest {
...
/**
 * 接口 [活期持仓资产自动转入确认前校验↗](https://yapi.coin-online.cc/project/72/interface/api/1646) 的 **返回类型**
 *
 * @分类 [热币宝理财↗](https://yapi.coin-online.cc/project/72/interface/api/cat_452)
 * @标签 `热币宝理财`
 * @请求头 `GET /finance/flexible/autoTransfer/check`
 * @更新时间 `2022-08-29 13:58:12`
 */
export interface YapiGetFinanceFlexibleAutoTransferCheckApiResponse {
  code?: number
  data?: number
  msg?: string
  pageNum?: number
